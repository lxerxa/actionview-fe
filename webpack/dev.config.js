...
export default {
  ...
  webpack: {
    ...
    entry: {
      ...
      common: ['react', 'react-dom', 'redux', 'redux-form', 'react-redux', 'react-router', 'react-router-redux', 'react-bootstrap', 'react-bootstrap-table', 'react-dnd', 'react-dnd-html5-backend' ]
    },
    output: {
      ...baseConfig.output,
      publicPath: PUBLIC_PATH
    ...
    module: {
      ...
      loaders: [
        ...
        },
        {
          ...
          exclude: /node_modules\/(?!font-awesome|cropper|react-select|bootstrap|react-bootstrap-table|react-datetime|rc-tabs|mermaid|react-dropzone-component|dropzone|simplemde)/
        }
      ]
    },
    plugins: [
