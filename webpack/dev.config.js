    ...
    module: {
      ...
      loaders: [
        ...baseConfig.module.loaders,
        {
          ...
          exclude: /node_modules\/(?!font-awesome|bootstrap|react-bootstrap-table|react-dropzone-component)/
        },
        {
          test: /\.css$/,
          loader: 'style!css!postcss',
          exclude: /node_modules\/(?!font-awesome|react-select|bootstrap|react-bootstrap-table|react-datetime|rc-tabs|mermaid|react-dropzone-component|simplemde)/
        }
      ]
    },
    plugins: [
