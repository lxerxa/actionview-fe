...
export default class EditModal extends Component {
  ...
  render() {
    const { fields: { id, name, start_time, end_time, description }, handleSubmit, invalid, dirty, submitting, data } = this.props;
      ...
      <Modal { ...this.props } onHide={ this.handleCancel } backdrop='static' aria-labelledby='contained-modal-title-sm'>
        ...
        <Modal.Body className={ submitting ? 'disable' : 'enable' }>
          <FormGroup controlId='formControlsText' validationState={ name.touched && name.error ? 'error' : '' }>
            ...
            <FormControl type='text' { ...name } placeholder='版本名'/>
          ...
          <FormGroup controlId='formControlsText' validationState={ end_time.value && end_time.error ? 'error' : '' }>
            ...
            <DateTime locale='zh-cn' mode='date' dateFormat='YYYY/MM/DD' timeFormat={ false } value={ end_time.value } onChange={ newValue => { end_time.onChange(newValue) } }/>
