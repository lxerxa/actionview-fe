...
const validate = (values, props) => {
  ...
  const usedKeys = [ 'id', 'type', 'state', 'assignee', 'priority', 'resolution', 'reporter', 'created_at', 'updated_at', 'no', 'schema', 'parent_id', 'parents', 'subtasks', 'links', 'entry_id', 'definition_id', 'comments', 'page', 'orderBy' ];
  if (!values.key) {
    errors.key = '必填';
