          ...
          <Tabs
            ...
            <TabPane tab='必填字段' key='3'>
              <div style={ { paddingTop: '15px' } }>
                ...
                <FormGroup controlId='formControlsText' style={ { marginTop: '15px' } }>
                  <div style={ { display: 'inline-block', width: '68%' } }>
                    <Select simpleValue options={ _.reject(screenFields, function(o) { return _.findIndex(cards2, function(o2) { return o2.id === o.value; }) !== -1; }) } clearable={ false } value={ this.state.addFieldIds2 } onChange={ this.handleChange2.bind(this) } placeholder='请选择必填字段' multi/>
                  </div>
