      ...
      <Modal { ...this.props } onHide={ this.handleCancel } backdrop='static' aria-labelledby='contained-modal-title-sm'>
        ...
        <Modal.Body>
          <FormGroup controlId='formControlsText' validationState={ name.touched && name.error ? 'error' : '' }>
            ...
            <Select.Async simpleValue clearable={ false } disabled={ submitting } options={ [] } value={ parent_id.value } onChange={ (newValue) => { parent_id.onChange(newValue) } } valueKey='id' labelKey='name' loadOptions={ this.searchIssue.bind(this) } placeholder='请输入问题号或
名称'/>
