...
export default class Project extends Component {
  ...
  render() {
    ...
    if (ecode !== 0) {
      ...
      return (<div/>);
    } else if ((/^\/project\/(\w+)(\/(summary|issue|activity|version|module|team|config))?$/.test(pathname) && options.permissions.indexOf('watch_project') === -1) || ((/^\/project\/(\w+)\/(type|workflow|field|screen|priority|state|resolution|role|events)(\/\w+)*$/).test(pathname) && options.permissions.indexOf('manage_project') === -1)) {
