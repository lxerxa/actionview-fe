...
export default generateConstants([
  ...
  'DOCUMENT_COPY(ASYNC)',
  'DOCUMENT_MOVE(ASYNC)',
  'DOCUMENT_DIRTREE_GET(ASYNC)',
  'DOCUMENT_DIRCHILDREN_GET(ASYNC)',
  'DOCUMENT_FAVORITE(ASYNC)',
  ...
  'WIKI_COPY(ASYNC)',
  'WIKI_MOVE(ASYNC)',
  'WIKI_DIRTREE_GET(ASYNC)',
  'WIKI_DIRCHILDREN_GET(ASYNC)',
  'WIKI_FAVORITE(ASYNC)',
  ...
  'REMINDS_INDEX(ASYNC)',
  'REMINDS_CREATE(ASYNC)',
  'REMINDS_SELECT',
  'REMINDS_UPDATE(ASYNC)',
  'REMINDS_DELETE(ASYNC)',
