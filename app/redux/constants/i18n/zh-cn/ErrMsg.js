export default { 
  ...
  '-11114': '该问题不能转化成子任务',
  '-11115': '流程提交失败',
  '-11116': '当前用户没有分配问题of权限',
  '-11117': '当前用户没有被分配问题of权限',
  '-11118': '指定用户没有被分配问题of权限',
  '-11119': '获取导入文件失败',
  '-11120': '导入文件内容解析错误',
  '-11121': '必填项不满足',
  '-11122': '时间选择字段格式有误',
  ...
  '-11705': '启动ofSprint编号不能为空',
  '-11706': '活动中ofSprint已存在',
  '-11707': '更先ofSprint已存在',
  '-11708': 'Sprint不存在或不在项目当中',
  '-11709': 'Sprint计划开始时间不能为空',
  '-11710': 'Sprint计划结束时间不能为空',
  '-11711': '要完成ofSprint不能为空',
  '-11712': '要完成ofSprint必须是活动中of',
  '-11713': '要完成ofSprint问题有错误',
  '-11714': '要删除ofSprint编号不能为空',
  '-11715': '活动中of或已完成ofSprint不能被删除',
  '-11716': '问题不能移出或移入已完成ofSprint中',
  '-11717': '看板ID不能为空',
