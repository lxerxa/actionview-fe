...
export default function(router) {
  ...
  router.get('/project/recent', function(req, res) {
    const startTime = new Date().getTime();
    while (new Date().getTime() < startTime + 2000);
    const results = { ecode: 0, data: [{ id: '546761', name: '社交化项目管理系统', key: 'SPMS', creator: '卢红兵', create_time: 144444 },{ id: '54676i2', name: '企业安全网盘', key: 'WEBDISK', creator: '王仕喜', create_time: 144444 },{ id: '5s46761', name: '社交化项目管理系统', key: 'BOBA', creator: '卢红兵', create_time: 144444 },{ id: '54r676i2', name: '企业安全网盘', key: 'WEBDISK', creator: '王仕喜', create_time: 144444 },{ id: '5i46761', name: '社交化项目管理系统', key: 'SPMS', creator: '卢红兵', create_time: 144444 },{ id: '54aa676i2', name: '企业安全网盘', key: 'WEBDISK', creator: '王仕喜', create_time: 144444 },{ id: '54bgg6761', name: '社交化项目管理系统', key: 'SPMS', creator: '卢红兵', create_time: 144444 }], options: { 'total': 8 } };
    return res.status(200).send(results);
  });
  ...
  router.get('/project/:key/issue', function(req, res) {
    const startTime = new Date().getTime();
    while (new Date().getTime() < startTime + 2000);
    const results = { ecode: 0, options: { 'total': 8 }, data: [{ no:1555, id: '546761', type:'1111', title: '国拨类型的项目添加任务中责任人没有必选*号', description:'bbbbb', priority:'1111', state:'546761', epic: '1111', creator: {id:'aaa', name:'刘旭（研究院）'}, created_at: '2016-08-15T14:01:52.683Z', watching: true },{ no:9999, id: '546763', type:'1111', title: 'osn首页“项目周月报”未填写的本月月报显示为本月待填', assignee:{id:'aaa', name:'刘旭（研究院）'}, priority:'2222', state:'546761', epic: '2222', created_at: '2016-08-15T14:01:52.683Z', rank: 98 },{ no:3, id: '546762', type:'2222', assignee: {id:'xxxx', name:'liuxu'}, title: 'OSN首页右上角新建报工窗口，提交成功后窗口关闭没有提示信息', priority:'3333', state:'546762', epic: '1111', creator: {id:'aaa', name:'刘旭（研究院）'}, created_at: '2016-08-15T14:01:52.683Z', rank: 49},{ no:4, id: '2323', title: 'OSN首页-我的日程起止时间，第一行和第二行字体大小相同' , created_at: '2016-08-15T14:01:52.683Z', rank: 88 },{ no:1, id: '5426761', type:'1111', title: '国拨类型的项目添加任务中责任人没有必选*号', description:'bbbbb', priority:'1111', state:'546763', epic: '2222', creator: {id:'aaa', name:'刘旭（研究院）'}, created_at: '2016-08-15T14:01:52.683Z', rank: 21 },{ no:2, id: '5462763', type:'1111', title: 'osn首页“项目周月报”未填写的本月月报显示为本月待填', assignee:{id:'aaa', name:'刘旭（研究院）'}, priority:'2222', state:'546762', epic: '2222', created_at: '2016-08-15T14:01:52.683Z', rank: 35 },{ no:365, id: '5467621', type:'2222', assignee: {id:'xxxx', name:'liuxu'}, title: 'OSN首页右上角新建报工窗口，提交成功后窗口关闭没有提示信息', priority:'3333', state:'546761', creator: {id:'aaa', name:'刘旭（研究院）'}, created_at: '2016-08-15T14:01:52.683Z', rank: 23},{ no:8, type: '1111', id: '22323', title: 'OSN首页-我的日程起止时间，第一行和第二行字体大小相同' , created_at: '2016-08-15T14:01:52.683Z', priority:'1111', state: '546762', parent: { no: 2, title: 'tttt', id: '54624763', state: '546762' }, rank : 100}, { no:7, type: '1111', id: '2232dd3', title: 'OSN首页-我>的日程起止时间，第一行和第二行字体大小相同' , created_at: '2016-08-15T14:01:52.683Z', priority:'1111', state: '546762', parent: { no: 2, title: 'tttt', id: '5462763', state: '546762' }, rank : 100}] };
    return res.status(200).send(results);
  });
  ...
  router.get('/project/:key/workflow/:id', function(req, res) {
    ...
    options: { states : [{id: '1111', category: 'new', name:'test1'}, {id: '2222', category: 'inprogress',name:'test2'}, {id: '3333', category: 'completed',name:'test3'}], permissions:[{id: '1111', name:'permission1'}, {id: '2222', name:'permission2'}, {id: '3333', name:'permission3'}], roles: [{id: '1111', name:'role1'}, {id: '2222', name:'role2'}, {id: '3333', name:'role3'}], screens:[{id: '1111', name:'screen1'}, {id: '2222', name:'screen2'}, {id: '3333', name:'screen3'}], users: [{ id: '111', name:'刘旭', email: 'liuxuyjy@chinamobile.com' }, { id: '222', name:'葛鹏', email: 'gepeng@chinamobile.com' }], events: [ {id: '1111', name: '一般事件'}, { id: '2222', name: 'ceshi'} ] }
};
    return res.status(200).send(results);
  });
  ...
  router.get('/project/:key/activity', function(req, res) {
    const startTime = new Date().getTime();
    while (new Date().getTime() < startTime + 2000);
    const results = { ecode: 0, data: [{ id: '54dd6761', event_key: 'del_file', user : { id : '57afced21d41c8174d7421c1', name : '刘旭', email : 'liuxuyjy@chinamobile.com' }, data : 'aaa.jpg', issue: { id: '1111', no: '23', title: '1111111111111' }, created_at: 1520943111 }, { id: '546763', event_key: 'add_file', user : { id : '57afced21d41c8174d7421c1', name : '刘旭', email : 'liuxuyjy@chinamobile.com' }, data : 'bbb.jpg', issue: { id: '1111', no:'45', title: '1111111111111' }, created_at: 1520929420 }, { id: '546761', event_key: 'create_issue', user : { id : '57afced21d41c8174d7421c1', name : '刘旭', email : 'liuxuyjy@chinamobile.com' }, issue: { id: '1111', no:'324', title: '1111111111111' }, data: '', created_at: 1520922345 }, { id: '54s6763', user : { id : '57afced21d41c8174d7421c1', name : '刘旭', email : 'liuxuyjy@chinamobile.com' }, event_key: 'edit_issue', data: [{ field : '主题', after_value : 'jjjjjjj', type : 'Text' }, { field : '优先级', after_value : '一般', type : 'Select'} ], issue: { id: '1111', no: '77', title: '1111111111111' }, created_at: 1520922345 }], options: { current_time: 1520943279 } };
    return res.status(200).send(results);
  });
  /******************Activity***************/
