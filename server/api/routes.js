...
export default function(router) {
  ...
  router.get('/project/:key/issue/546761', function(req, res) {
    const startTime = new Date().getTime();
    while (new Date().getTime() < startTime + 2000);
    const results = { ecode: 0, data: { id: '546761', no:155, name: 'aaaaaaa', links: [{src:{id:'546761', no:111, type:'2222', title:'aaaaaaa'}, dest:{id:'546762', no:112, type:'2222', title:'aaaaaaa'}, relation:'is blocked by'}, {dest:{id:'546761', no:111, type:'2222', title:'aaaaaaa'}, src:{id:'546762', no:113, type:'2222', title:'bbbbb'}, relation:'is blocked by'}, {src:{id:'546761', no:111, type:'2222', title:'aaaaaaa'}, dest:{id:'546762', no:114, type:'2222', title:'cccc'}, relation:'is cloned by'}], description: 'bbbbbb', assignee:{ id: '1111', name: '刘旭' },type: '2222', title: '国拨类型的项目添加任务中责任人没有必选*号', priority:'1111', state:'2222', expect_time: 1478415469, version: '1111,2222', wfactions: [ {name:'纳入迭代', screen: '11111', action:'1111' }, { name:'纳入迭代', screen: '11111', action:'1111' }, { name:'纳入迭代', screen: '11111', action:'1111' } ], attachments:[{id: '1111',type:'image/jpeg', uploader:'aaaa', size: 2222, time:1474646499, name: '截图.jpeg'}, {id: '2222',type:'docx', uploader:'aaaa', size: 2222, time:1474646499, name: '测试.docx'},{id: '2222',type:'docx',uploader:'aaaa', size: 2222, time:1474646499, name: '测试2.docx'}, {id: '4444',type:'image/png',uploader:'aaaa', size: 2222, time:1474646499, name: '截图3.jpeg'}] } };
    return res.status(200).send(results);
  });
