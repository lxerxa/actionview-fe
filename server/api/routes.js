...
export default function(router) {
  ...
  router.get('/project/:key/issue', function(req, res) {
    const startTime = new Date().getTime();
    while (new Date().getTime() < startTime + 2000);
    const results = { ecode: 0, options: { 'total': 9 }, data: [{ no:1555, id: '546761', type:'1111', labels:['视频转码', '管理员'],title: '任务中责任人没有必选*号', description:'bbbbb', priority:'1111', state:'546761', epic: '1111', resolve_version: '1111', reporter: {id:'aaa', name:'王五'}, created_at: '1533636586', expect_complete_time: 1534646586, expect_start_time: 1533636586, progress: 80, watching: true },{ no:9999, id: '546763', type:'1111', labels:['视频转码', '管理员'], title: 'demo首页未填写的本月月报显示为本月待填', assignee:{id:'aaa', name:'王五'}, priority:'2222', state:'546761', epic: '2222', created_at: '1533636586', expect_complete_time: 1534446586, expect_start_time: 1533636586, progress: 50, rank: 98 },{ no:3, id: '546762', type:'2222', assignee: {id:'xxxx', name:'wangwu'}, title: 'demo首页右上角新建窗口，提交成功后窗口关闭没有提示信息', priority:'3333', state:'546762', epic: '1111', reporter: {id:'aaa', name:'王五'}, created_at: '1533636586', rank: 49},{ no:4, id: '2323', title: 'demo首页-我的日程起止时间，第一行和第二行字体大小相同' , created_at: '1533636586', rank: 88 },{ no:1, id: '5426761', type:'1111', title: 'dsaffsafsafsdf', description:'bbbbb', priority:'1111', state:'546763', epic: '2222', reporter: {id:'aaa', name:'王五'}, created_at: '1533636586', rank: 21 },{ no:2, id: '5462763', type:'1111', labels:['视频转码', '管理员'], title: 'xxxxxxxxxxxx', assignee:{id:'aaa', name:'王五'}, priority:'2222', state:'546762', epic: '2222', created_at: '1533636586', rank: 35 },{ no:365, id: '5367621', type:'2222', assignee: {id:'xxxx', name:'wangwu'}, title: 'YYYYYYYYYYYYYYY', priority:'3333', state:'546761', reporter: {id:'aaa', name:'王五'}, created_at: '1533636586', rank: 23},{ no:8, type: '1111', id: '22323', title: 'ZZZZZZZZZZZZZZ' , created_at: '1533636586', expect_complete_time: 1534446586, expect_start_time: 1533636586, priority:'1111', state: '546762', parent: { no: 2, title: 'xxxxxxxxxxxx', id: '5462763', state: '546762' }, rank : 100}, { no:7, type: '1111', id: '2232dd3', title: 'demo首页-ssssssss' , created_at: '1533636586', priority:'1111', state: '546762', parent: { no: 2, title: 'xxxxxxxxxxxx', id: '5462763', state: '546762' }, rank : 100}] };
    return res.status(200).send(results);
  });
