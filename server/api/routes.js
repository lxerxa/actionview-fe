...
export default function(router) {
  ...
  router.get('/syssetting', function(req, res) {
    ...
    const results = { ecode: 0, data: { properties: { allowed_login_num: 3, login_mail_domain: 'chinamobile.com', week2day: 5, day2hour: 8 }, mailserver: { smtp: { host: '10.2.5.34', port: 25, tls: 1, username:'xxxxx', password: '******' }, send: { from: 'actionview@126.com', prefix: 'actionview' }}, sysroles: { sys_admin: [ { id: 'nhy67ujm', email:'liulaoyao@chinamobile.com', name: 'liulaoyao' }, { id: 'nhy67ujm2', email:'liulaoyao@chinamobile.com', name: 'liulaoyaoaaaa' } ] } } };
  ...
  router.get('/mysetting', function(req, res) {
    const startTime = new Date().getTime();
    while (new Date().getTime() < startTime + 2000);
    const results = { ecode: 0, data: { accounts: { avatar: '', name: '刘老幺', email: 'liulaoyao@chinamobile.com', department: '科技管理部', phone: 13811450899}, notifications: { mail_notify: true, mobile_notify: true, daily_notify: false, monthly_notify: false }, favorites: { language: 'chinese' } } };
    return res.status(200).send(results);
  });
  ...
  router.get('/user/search', function(req, res) {
    const startTime = new Date().getTime();
    while (new Date().getTime() < startTime + 2000);
    const results = { ecode: 0, data: [{ id: '1111', name: '刘老幺111', email: 'liulaoyao@chinamobile.com', phone: 13811450899, status: 'active'}, {id: '111122', name: '刘老幺111',email: 'liulaoyao@chinamobile.com', phone: 13811450899, status: 'active'},  { id: '111111', name: '刘老幺11331',email: 'liulaoyao@chinamobile.com', phone: 13811450899, status: 'active'}, { id: '11133111', name: '刘老幺111333', email: 'liulaoyao@chinamobile.com', phone: 13811450899, status: 'closed'} ] };
    return res.status(200).send(results);
  });
  ...
  router.get('/group/search', function(req, res) {
    const startTime = new Date().getTime();
    while (new Date().getTime() < startTime + 2000);
    const results = { ecode: 0, data: [{ id: '1111', name: '111' }, {id: '111122', name: '刘老幺111'},  { id: '111111', name: '刘老幺11331'}, { id: '11133111', name: '刘老幺111333'} ] };
    return res.status(200).send(results);
  });
  ...
  router.get('/myproject', function(req, res) {
    const startTime = new Date().getTime(); 
    while (new Date().getTime() < startTime + 2000);
    const results = { ecode: 0, data: [{ id: '1111', status: 'active', name: '社交化项目管理系统', description: 'aaaabbbbccc测试测试测试测试测试测试测测试时测试测试测试测试测试测试', key: 'SPMS', creator: '卢十兵', create_time: 144444, principal: { id: 'nhy67ujm', nameAndEmail:'liulaoyao@aa.com', name: '刘老幺' } },{ id: '2222', name: '企业安全网盘', key: 'WEBDISK', creator: '王十喜', create_time: 144444, principal: { id: 'zzz', name: '刘老幺' } },{ id: '3333', name: '社交化项目管理系统', key: 'SPMS', creator: '卢十兵', create_time: 144444, principal: { id: 'zzz', name: '刘老幺' } },{ id: '4444', name: '企业安全网盘', key: 'WEBDISK', creator: '王十喜', create_time: 144444, principal: { id: 'zzz', name: '王十喜' }}] };
    return res.status(200).send(results);
  });
  ...
  router.get('/project/recent', function(req, res) {
    const startTime = new Date().getTime();
    while (new Date().getTime() < startTime + 2000);
    const results = { ecode: 0, data: [{ id: '546761', name: '社交化项目管理系统', key: 'SPMS', creator: '卢十兵', create_time: 144444 },{ id: '54676i2', name: '企业安全网盘', key: 'WEBDISK', creator: '王十喜', create_time: 144444 },{ id: '5s46761', name: '社交化项目管理系统', key: 'BOBA', creator: '卢十兵', create_time: 144444 },{ id: '54r676i2', name: '企业安全网盘', key: 'WEBDISK', creator: '王十喜', create_time: 144444 },{ id: '5i46761', name: '社交化项目管理系统', key: 'SPMS', creator: '卢十兵', create_time: 144444 },{ id: '54aa676i2', name: '企业安全网盘', key: 'WEBDISK', creator: '王十喜', create_time: 144444 },{ id: '54bgg6761', name: '社交化项目管理系统', key: 'SPMS', creator: '卢十兵', create_time: 144444 }], options: { 'total': 8 } };
    return res.status(200).send(results);
  });
  ...
  router.get('/project', function(req, res) {
    const startTime = new Date().getTime(); 
    while (new Date().getTime() < startTime + 2000);
    const results = { ecode: 0, data: [{ id: '546761', name: '社交化项目管理系统', key: 'SPMS', creator: '卢十兵', create_time: 144444 },{ id: '54676i2', name: '企业安全网盘', key: 'WEBDISK', creator: '王十喜', create_time: 144444 },{ id: '5s46761', name: '社交化项目管理系统', key: 'SPMS', creator: '卢十兵', create_time: 144444 },{ id: '54r676i2', name: '企业安全网盘', key: 'WEBDISK', creator: '王十喜', create_time: 144444 },{ id: '5i46761', name: '社交化项目管理系统', key: 'SPMS', creator: '卢十兵', create_time: 144444 },{ id: '54aa676i2', name: '企业安全网盘', key: 'WEBDISK', creator: '王十喜', create_time: 144444 },{ id: '54bgg6761', name: '社交化项目管理系统', key: 'SPMS', creator: '卢十兵', create_time: 144444 }], options: { 'total': 8 } };
  ...
  router.get('/project/:key', function(req, res) {
    const results = { ecode: 0, data: { id: '546761', name: '播吧', key: 'BOBA', principal: { id:'xxx', name: '刘老幺' }, creator: '刘老幺', create_time: 144444 }, options: { permissions: [ 'manage_project', 'create_issue', 'edit_issue', 'exec_workflow', 'link_issue', 'view_project', 'download_file', 'remove_file' ] }};
    return res.status(200).send(results);
  });
  ...
  router.post('/project', function(req, res) {
    const startTime = new Date().getTime(); 
    while (new Date().getTime() < startTime + 2000);
    const results = { ecode: 0, data: { id: '546761', name: '播吧', key: 'BOBA', principal: { id: 'zzz', name: '王十喜' }, creator: '刘老幺', create_time: 144444 }};
    return res.status(200).send(results);
  });
  ...
  router.get('/project/:key/issue', function(req, res) {
    const startTime = new Date().getTime();
    while (new Date().getTime() < startTime + 2000);
    const results = { ecode: 0, options: { 'total': 8 }, data: [{ no:1555, id: '546761', type:'1111', title: '国拨类型的项目添加任务中责任人没有必选*号', description:'bbbbb', priority:'1111', state:'546761', epic: '1111', resolve_version: '1111', creator: {id:'aaa', name:'刘老幺'}, created_at: '2016-08-15T14:01:52.683Z', watching: true },{ no:9999, id: '546763', type:'1111', title: 'osn首页“项目周月报”未填写的本月月报显示为本月待填', assignee:{id:'aaa', name:'刘老幺'}, priority:'2222', state:'546761', epic: '2222', created_at: '2016-08-15T14:01:52.683Z', rank: 98 },{ no:3, id: '546762', type:'2222', assignee: {id:'xxxx', name:'liulaoyao'}, title: 'OSN首页右上角新建报工窗口，提交成功后窗口关闭没有提示信息', priority:'3333', state:'546762', epic: '1111', creator: {id:'aaa', name:'刘老幺'}, created_at: '2016-08-15T14:01:52.683Z', rank: 49},{ no:4, id: '2323', title: 'OSN首页-我的日程起止时间，第一行和第二行字体大小相同' , created_at: '2016-08-15T14:01:52.683Z', rank: 88 },{ no:1, id: '5426761', type:'1111', title: '国拨类型的项目添加任务中责任人没有必选*号', description:'bbbbb', priority:'1111', state:'546763', epic: '2222', creator: {id:'aaa', name:'刘老幺'}, created_at: '2016-08-15T14:01:52.683Z', rank: 21 },{ no:2, id: '5462763', type:'1111', title: 'osn首页“项目周月报”未填写的本月月报显示为本月待填', assignee:{id:'aaa', name:'刘老幺'}, priority:'2222', state:'546762', epic: '2222', created_at: '2016-08-15T14:01:52.683Z', rank: 35 },{ no:365, id: '5467621', type:'2222', assignee: {id:'xxxx', name:'liulaoyao'}, title: 'OSN首页右上角新建报工窗口，提交成功后窗口关闭没有提示信息', priority:'3333', state:'546761', creator: {id:'aaa', name:'刘老幺'}, created_at: '2016-08-15T14:01:52.683Z', rank: 23},{ no:8, type: '1111', id: '22323', title: 'OSN首页-我的日程起止时间，第一行和第二行字体大小相同' , created_at: '2016-08-15T14:01:52.683Z', priority:'1111', state: '546762', parent: { no: 2, title: 'tttt', id: '54624763', state: '546762' }, rank : 100}, { no:7, type: '1111', id: '2232dd3', title: 'OSN首页-我>的日程起止时间，第一行和第二行字体大小相同' , created_at: '2016-08-15T14:01:52.683Z', priority:'1111', state: '546762', parent: { no: 2, title: 'tttt', id: '5462763', state: '546762' }, rank : 100}] };
    return res.status(200).send(results);
  });
  ...
  router.get('/project/:key/issue/:id/worklog', function(req, res) {
    const startTime = new Date().getTime();
    while (new Date().getTime() < startTime + 2000);
    const results = { ecode: 0, data: [{ id: '1111', started_at: 1478414469, adjust_type: '1', spend: '3d 4h', comments: '1111111', recorder: {id:'aaa', name:'刘老幺'}, recorded_at: 1478414469 }, { id: '2222', started_at: 1478414469, adjust_type: '2', spend: '6h', comments: '2222222', recorder: {id:'aaa', name:'刘老幺'}, recorded_at: 1478414469 }, { id: '3333', started_at: 1478414469, adjust_type: 1, spend: '3d 4h 5m', comments: '333333',recorder: {id:'aaa', name:'刘老幺'}, recorded_at: 1478414469 }] };
    return res.status(200).send(results);
  });
  ...
  router.get('/project/:key/issue/:id/history', function(req, res) {
    const startTime = new Date().getTime();
    while (new Date().getTime() < startTime + 2000);
    const results = { ecode: 0, data: [{ operator: { id: '1111', name: '刘老幺', email: 'bbb' }, operated_at: 1478414469, operation: 'modify',items: [ { field: '优先级', before: 'aa', after: 'bb' }, { field: '优先级', before: 'aa', after: 'bb'}, { field: '优先级', before: 'aa', after: 'bb'} ] }, { operator: { id: '1111', name: '刘老幺', email: 'tttt' }, operated_at: 1478415479, operation: 'modify',items: [ { field: '优先级', before: 'aa', after: 'bb' }, { field: '优先级22', before: 'aa', after: 'bb'}, { field: '优先级3', before: 'aa', after: 'bb'} ] }, { operator: { id: '1111', name: '刘老幺' }, operated_at: 1478415469, operation: 'new' }] };
    return res.status(200).send(results);
  });
  ...
  router.get('/project/:key/issue/:id/comments', function(req, res) {
    const startTime = new Date().getTime();
    while (new Date().getTime() < startTime + 2000);
    const results = { ecode: 0, data: [{ id: '1111', contents: 'aaaaaa', creator: {id:'aaa', name:'刘老幺'}, created_at: 1478415469, edited_flag : 1 }, {id: '2222', contents: '@刘老幺 bbbb\r\nbbbb', atWho: [ {id: '111', name: '刘老幺', email: 'liulaoyao@chinamobile.com'} ], creator: {id:'aaa', name:'刘老幺'}, created_at: 1478415469, reply: [ { id: '111', to: { id: '111', name: '刘老幺', email: 'liulaoyao@chinamobile.com' }, contents: '测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试>测试测试测试', created_at: 1478415469, updated_at: 1478415469, creator: {id: '111', name: '刘老幺', email: 'liulaoyao@chinamobile.com'} }, {id: '2222', contents: '测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试>测试测试测试', created_at: 1478415469, updated_at: 1478415469, creator: {id: '111', name: '刘老幺', email: 'liulaoyao@chinamobile.com'} } ] }, {id: '3333', contents: 'aaaaaa', creator: {id:'aaa', name:'刘老幺'}, created_at: 1478415469}] }; 
    return res.status(200).send(results);
  });
  ...
  router.post('/project/:key/issue/:id/comments', function(req, res) {
    const startTime = new Date().getTime();
    while (new Date().getTime() < startTime + 2000);
    const results = { ecode: 0, data: { id: '5555', contents: 'ttttttt', creator: {id:'aaa', name:'刘老幺'}, created_at: 1478415469 } };
    return res.status(200).send(results);
  });
  ...
  router.post('/project/:key/issue', function(req, res) {
    const startTime = new Date().getTime();
    while (new Date().getTime() < startTime + 2000);
    const results = { ecode: 0, data: { no:1, id: '546761', type:'1111', title: '国拨类型的项目添加任务中责任人没有必选*号', description:'bbbbb', priority:'1111', state:'2222', creator: {id:'aaa', name:'刘老幺'} } };
    return res.status(200).send(results);
  }); 
  ...
  router.get('/project/:key/workflow/:id', function(req, res) {
    ...
    options: { states : [{id: '1111', category: 'new', name:'test1'}, {id: '2222', category: 'inprogress',name:'test2'}, {id: '3333', category: 'completed',name:'test3'}], permissions:[{id: '1111', name:'permission1'}, {id: '2222', name:'permission2'}, {id: '3333', name:'permission3'}], roles: [{id: '1111', name:'role1'}, {id: '2222', name:'role2'}, {id: '3333', name:'role3'}], screens:[{id: '1111', name:'screen1'}, {id: '2222', name:'screen2'}, {id: '3333', name:'screen3'}], users: [{ id: '111', name:'刘老幺', email: 'liulaoyao@chinamobile.com' }, { id: '222', name:'葛老十', email: 'gelaoshi@chinamobile.com' }], events: [ {id: '1111', name: '一般事件'}, { id: '2222', name: 'ceshi'} ] }
};
    return res.status(200).send(results);
  });
  ...
  router.get('/project/:key/state', function(req, res) {
    const startTime = new Date().getTime();
    while (new Date().getTime() < startTime + 2000);
    const results = { ecode: 0, data: [{ id: '546761', category:'new', name: '开发中', description: 'aaaaaaaaaaa'},{ id: '546763', category: 'inprogress', name: '待测试', description: 'aaaaaaaaaaa', default: true },{ id: '546762', category: 'completed', name: '已发布' },{ id: '2323', name: '已关闭', description: 'ddddddddddd' }]};
    return res.status(200).send(results);
  });
  ...
  router.get('/project/:key/team', function(req, res) {
    const startTime = new Date().getTime();
    while (new Date().getTime() < startTime + 2000);
    const results = { ecode: 0, data: [{ id: '546761', name: '项目经理', description: '111aaa', permissions:[ 'create_issue', 'edit_issue'], users: [{id: '1111', name: 'liulaoyao', email: 'liulaoyao@aa.com' }, {id: '2222', name: 'lihui', email: 'lihui@aa.com'}] }, { id: '546762', name: '产品经理', permissions:['create_issue', 'edit_issue'], users: [{id: '1111', name: 'liulaoyao', email: 'liulaoyao@aa.com'}] }] };
    return res.status(200).send(results);
  });
  ...
  router.post('/session', function(req, res) {
    const startTime = new Date().getTime();
    while (new Date().getTime() < startTime + 2000);
    const results = { ecode: 0, data: { user: { id: 'nhy67ujm', email:'liulaoyao@chinamobile.com', first_name: 'liulaoyao', avatar: '', permissions: {sys_admin: true}, latest_access_url: '/project/boba/summary' }}};
    return res.status(200).send(results);
  });
  ...
  router.get('/session', function(req, res) {
    const startTime = new Date().getTime();
    while (new Date().getTime() < startTime + 2000);
    const results = { ecode: 0, data: { user: { id: 'nhy67ujm', email:'liulaoyao@chinamobile.com', first_name: 'liulaoyao', avatar: 'http://tp1.sinaimg.cn/2214067364/180/5605327547/1', permissions: { sys_admin: true } }}};
    return res.status(200).send(results);
  });

  router.get('/user', function(req, res) {
    const results = { ecode: 0, data: [{id: '1111', name: 'liulaoyao'}, {id: '2222', name: 'lihui'}]};
    return res.status(200).send(results);
  });
  ...
  router.get('/project/:key/events', function(req, res) {
    const startTime = new Date().getTime();
    while (new Date().getTime() < startTime + 2000);
    const results = { ecode: 0, data: [{ id: '546761', name: '创建问题', notifications: [  'assignee', 'reporter','project_principal', { key: 'role', value: '1111'}, { key: 'single_user_field', value: '1111' } ] },{ id: '546763', name: '编辑问题', notifications: [ 'assignee', 'reporter', 'project_principal', { key: 'multi_user_field', value: '2222' } ] },{ id: '546762', name: '删除问题' },{ id: '2323', name: '添加备注', notifications: [ 'assignee', 'reporter', 'module_principal' ] }], options:{ users: [{ id: '111', name:'刘老幺', email:'liulaoyao@chinamobile.com' }, { id: '222', name:'葛老十', email: 'gelaoshi@chinamobile.com' }], roles: [{id: '1111', name:'role1'}, {id: '2222', name:'role2'}, {id: '3333', name:'role3'}], single_user_fields: [{id: '1111', name:'field1'}, {id: '2222', name:'field2'}, {id: '3333', name:'field3'}], multi_user_fields: [{id: '1111', name:'field1'}, {id: '2222', name:'field2'}, {id: '3333', name:'field3'}] }};
    return res.status(200).send(results);
  });
  ...
  router.get('/project/:key/activity', function(req, res) {
    const startTime = new Date().getTime();
    while (new Date().getTime() < startTime + 2000);
    const results = { ecode: 0, data: [{ id: '54dd6761', event_key: 'del_file', user : { id : '57afced21d41c8174d7421c1', name : '刘老幺', email : 'liulaoyao@chinamobile.com' }, data : 'aaa.jpg', issue: { id: '1111', no: '23', title: '1111111111111' }, created_at: 1520943111 }, { id: '546763', event_key: 'add_file', user : { id : '57afced21d41c8174d7421c1', name : '刘老幺', email : 'liulaoyao@chinamobile.com' }, data : 'bbb.jpg', issue: { id: '1111', no:'45', title: '1111111111111' }, created_at: 1520929420 }, { id: '546761', event_key: 'create_issue', user : { id : '57afced21d41c8174d7421c1', name : '刘老幺', email : 'liulaoyao@chinamobile.com' }, issue: { id: '1111', no:'324', title: '1111111111111' }, data: '', created_at: 1520922345 }, { id: '54s6763', user : { id : '57afced21d41c8174d7421c1', name : '刘老幺', email : 'liulaoyao@chinamobile.com' }, event_key: 'edit_issue', data: [{ field : '主题', after_value : 'jjjjjjj', type : 'Text' }, { field : '优先级', after_value : '一般', type : 'Select'} ], issue: { id: '1111', no: '77', title: '1111111111111' }, created_at: 1520922345 }], options: { current_time: 1520943279 } };
    return res.status(200).send(results);
  });
  /******************Activity***************/
