...
export default function(router) {
  ...
  router.get('/project/:key', function(req, res) {
    const results = { ecode: 0, data: { id: '546761', name: '视频网站', key: 'BOBA', principal: { id:'xxx', name: '刘老幺' }, creator: '刘老幺', create_time: 144444 }, options: { permissions: [ 'manage_project', 'reset_issue', 'create_issue', 'edit_issue', 'exec_workflow', 'link_issue', 'view_project', 'download_file', 'remove_file', 'upload_file', 'assign_issue' ] }};
    return res.status(200).send(results);
  });
  ...
  router.get('/project/:key/module', function(req, res) {
    const startTime = new Date().getTime();
    while (new Date().getTime() < startTime + 2000);
    const results = { ecode: 0, data: [{ id: '546761', name: '任务', description:'bbbbb', principal: { name: 'lihui', id: '111'}, defaultAssignee_id:'111'},{ id: '546763', name: '需求', principal_id:'222', defaultAssignee_id:'111', default: true },{ id: '546762', name: '缺陷', principal_id:'111', defaultAssignee_id:'111'},{ id: '2323', name: '子任务'}], options:{ users: [{ id: '111', name:'刘老幺', email:'liulaoyao@chinamobile.com' }, { id: '222', name:'李老师', email: 'lilaoshi@chinamobile.com' }] }};
    return res.status(200).send(results);
  });
  ...
  router.get('/project/:key/workflow/:id', function(req, res) {
    ...
    options: { states : [{id: '1111', category: 'new', name:'test1'}, {id: '2222', category: 'inprogress',name:'test2'}, {id: '3333', category: 'completed',name:'test3'}], permissions:[{id: '1111', name:'permission1'}, {id: '2222', name:'permission2'}, {id: '3333', name:'permission3'}], roles: [{id: '1111', name:'role1'}, {id: '2222', name:'role2'}, {id: '3333', name:'role3'}], screens:[{id: '1111', name:'screen1'}, {id: '2222', name:'screen2'}, {id: '3333', name:'screen3'}], users: [{ id: '111', name:'刘老幺', email: 'liulaoyao@chinamobile.com' }, { id: '222', name:'李老师', email: 'lilaoshi@chinamobile.com' }], events: [ {id: '1111', name: '一般事件'}, { id: '2222', name: 'ceshi'} ] }
};
    return res.status(200).send(results);
  });
  ...
  router.get('/project/:key/events', function(req, res) {
    const startTime = new Date().getTime();
    while (new Date().getTime() < startTime + 2000);
    const results = { ecode: 0, data: [{ id: '546761', name: '创建问题', notifications: [  'assignee', 'reporter','project_principal', { key: 'role', value: '1111'}, { key: 'single_user_field', value: '1111' } ] },{ id: '546763', name: '编辑问题', notifications: [ 'assignee', 'reporter', 'project_principal', { key: 'multi_user_field', value: '2222' } ] },{ id: '546762', name: '删除问题' },{ id: '2323', name: '添加备注', notifications: [ 'assignee', 'reporter', 'module_principal' ] }], options:{ users: [{ id: '111', name:'刘老幺', email:'liulaoyao@chinamobile.com' }, { id: '222', name:'李老师', email: 'lilaoshi@chinamobile.com' }], roles: [{id: '1111', name:'role1'}, {id: '2222', name:'role2'}, {id: '3333', name:'role3'}], single_user_fields: [{id: '1111', name:'field1'}, {id: '2222', name:'field2'}, {id: '3333', name:'field3'}], multi_user_fields: [{id: '1111', name:'field1'}, {id: '2222', name:'field2'}, {id: '3333', name:'field3'}] }};
    return res.status(200).send(results);
  });
