...
export default function(router) {
  ...
  router.get('/project/:key/issue', function(req, res) {
    const startTime = new Date().getTime();
    while (new Date().getTime() < startTime + 2000);
    const results = { ecode: 0, options: { 'total': 8 }, data: [{ no:1555, id: '546761', type:'1111', title: '国拨类型的项目添加任务中责任人没有必选*号', description:'bbbbb', priority:'1111', state:'2222', creator: {id:'aaa', name:'刘旭（研究院）'}, created_at: '2016-08-15T14:01:52.683Z', rank: 100 },{ no:9999, id: '546763', type:'1111', title: 'osn首页“项目周月报”未填写的本月月报显示为本月待填', assignee:{id:'aaa', name:'刘旭（研究院）'}, priority:'2222', state:'2222', created_at: '2016-08-15T14:01:52.683Z', rank: 98 },{ no:3, id: '546762', type:'2222', assignee: {id:'xxxx', name:'liuxu'}, title: 'OSN首页右上角新建报工窗口，提交成功后窗口关闭没有提示信息', priority:'3333', state:'1111', creator: {id:'aaa', name:'刘旭（研究院）'}, created_at: '2016-08-15T14:01:52.683Z', rank: 49},{ no:4, id: '2323', title: 'OSN首页-我的日程起止时间，第一行和第二行字体大小相同' , created_at: '2016-08-15T14:01:52.683Z', rank: 88 },{ no:1, id: '5426761', type:'1111', title: '国拨类型的项目添加任务中责任人没有必选*号', description:'bbbbb', priority:'1111', state:'2222', creator: {id:'aaa', name:'刘旭（研究院）'}, created_at: '2016-08-15T14:01:52.683Z', rank: 21 },{ no:2, id: '5462763', type:'1111', title: 'osn首页“项目周月报”未填写的本月月报显示为本月待填', assignee:{id:'aaa', name:'刘旭（研究院）'}, priority:'2222', state:'2222', created_at: '2016-08-15T14:01:52.683Z', rank: 35 },{ no:3, id: '5467621', type:'2222', assignee: {id:'xxxx', name:'liuxu'}, title: 'OSN首页右上角新建报工窗口，提交成功后窗口关闭没有提示信息', priority:'3333', state:'1111', creator: {id:'aaa', name:'刘旭（研究院）'}, created_at: '2016-08-15T14:01:52.683Z', rank: 23},{ no:4, id: '22323', title: 'OSN首页-我的日程起止时间，第一行和第二行字体大小相同' , created_at: '2016-08-15T14:01:52.683Z', rank : 100}] };
    return res.status(200).send(results);
  });
  ...
  router.get('/project/:key/kanban/access', function(req, res) {
    const startTime = new Date().getTime();
    while (new Date().getTime() < startTime + 2000);
    const results={ ecode: 0, data: { id: '1111' }, options: { kanbans: [{ id: '1111', name: '测试测试11', filters: [{name: '1111', query:{ assignees: 'me,ttt' }}, {name: '2222', query:{updated_at: '1w'}}, {name: '3333', query: {created_at: '1w'}}], columns: [{name: '待处理', states: ['2222','1111']}, {name:'处理中', states: ['3333']}, {name:'关闭', states:[]}], query: { type: '111,333' } }, { id: '2222', name:'2222', filters: [{name: 'mmmmmmm', query:{ assignees: 'me,ttt' }}, {name: 'nnnnnnn', query:{updated_at: '1w'}}, {name: 'tttt', query: {created_at: '1w'}}], columns: [{name: '待处理22', states: ['2222','1111']}, {name:'处理中22', states: ['3333']}, {name:'关闭22', states:[]}], query: { type: '111,222' } }] } };
    return res.status(200).send(results);
  });
  /******************kanban***************/
}
