...
export default function(router) {
  ...
  router.get('/mysetting', function(req, res) {
    const startTime = new Date().getTime();
    while (new Date().getTime() < startTime + 2000);
    const results = { ecode: 0, data: { accounts: { avatar: '', name: '刘老幺', email: 'liulaoyao@aaa.com', department: '科技部', phone: 13111111111}, notifications: { mail_notify: true, mobile_notify: true, daily_notify: false, monthly_notify: false }, favorites: { language: 'chinese' } } };
    return res.status(200).send(results);
  });
  ...
  router.put('/user/:id', function(req, res) {
    const startTime = new Date().getTime();
    while (new Date().getTime() < startTime + 2000);
    const results = { ecode: 0, data: { directory: 'self', id: '11133111', first_name: '刘老幺111333', email: 'liulaoyao@aaa.com', phone: 13111111111, status: 'active'} };
    return res.status(200).send(results);
  });
  ...
  router.get('/user', function(req, res) {
    const startTime = new Date().getTime(); 
    while (new Date().getTime() < startTime + 2000);
    const results = { ecode: 0, data: [{ id: '1111', first_name: '刘老幺111', email: 'liulaoyao@aaa.com', phone: 13111111111, groups:['aa', 'bb'], status: 'inactive'}, {id: '111122', first_name: '刘老幺111',email: 'liulaoyao@aaa.com', phone: 13111111111, status: 'invalid', directory: 'self'},  { directory: '1111', id: '111111', first_name: '刘老幺11331',email: 'liulaoyao@aaa.com', phone: 13111111111, status: 'active'}, { directory: 'self', id: '11133111', first_name: '刘老幺111333', email: 'liulaoyao@aaa.com', phone: 13111111111, status: 'active'} ], options: { groups: [{id:'111', name:'111'}, {id:'222', name:'222'}], directories: [{id:'1111', name:'111'}, {id:'2222', name:'222'}] } };
    return res.status(200).send(results);
  });
  ...
  router.get('/user/search', function(req, res) {
    const startTime = new Date().getTime();
    while (new Date().getTime() < startTime + 2000);
    const results = { ecode: 0, data: [{ id: '1111', name: '刘老幺111', email: 'liulaoyao@aaa.com', phone: 13111111111, status: 'active'}, {id: '111122', name: '刘老幺111',email: 'liulaoyao@aaa.com', phone: 13111111111, status: 'active'},  { id: '111111', name: '刘老幺11331',email: 'liulaoyao@aaa.com', phone: 13111111111, status: 'active'}, { id: '11133111', name: '刘老幺111333', email: 'liulaoyao@aaa.com', phone: 13111111111, status: 'closed'} ] };
    return res.status(200).send(results);
  });
  ...
  router.get('/project/:key/issue/:id/comments', function(req, res) {
    const startTime = new Date().getTime();
    while (new Date().getTime() < startTime + 2000);
    const results = { ecode: 0, data: [{ id: '1111', contents: 'aaaaaa', creator: {id:'aaa', name:'刘老幺'}, created_at: 1478415469, edited_flag : 1 }, {id: '2222', contents: '@刘老幺 bbbb\r\nbbbb', atWho: [ {id: '111', name: '刘老幺', email: 'liulaoyao@aaa.com'} ], creator: {id:'aaa', name:'刘老幺'}, created_at: 1478415469, reply: [ { id: '111', to: { id: '111', name: '刘老幺', email: 'liulaoyao@aaa.com' }, contents: '测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试>测试测试测试', created_at: 1478415469, updated_at: 1478415469, creator: {id: '111', name: '刘老幺', email: 'liulaoyao@aaa.com'} }, {id: '2222', contents: '测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试>测试测试测试', created_at: 1478415469, updated_at: 1478415469, creator: {id: '111', name: '刘老幺', email: 'liulaoyao@aaa.com'} } ] }, {id: '3333', contents: 'aaaaaa', creator: {id:'aaa', name:'刘老幺'}, created_at: 1478415469}], options: { current_time: 1520943279 } }; 
    return res.status(200).send(results);
  });
  ...
  router.get('/project/:key/workflow/:id', function(req, res) {
    ...
    options: { states : [{id: '1111', category: 'new', name:'test1'}, {id: '2222', category: 'inprogress',name:'test2'}, {id: '3333', category: 'completed',name:'test3'}], permissions:[{id: '1111', name:'permission1'}, {id: '2222', name:'permission2'}, {id: '3333', name:'permission3'}], roles: [{id: '1111', name:'role1'}, {id: '2222', name:'role2'}, {id: '3333', name:'role3'}], screens:[{id: '1111', name:'screen1'}, {id: '2222', name:'screen2'}, {id: '3333', name:'screen3'}], users: [{ id: '111', name:'刘老幺', email: 'liulaoyao@aaa.com' }, { id: '222', name:'李老师', email: 'lilaoshi@aaa.com' }], events: [ {id: '1111', name: '一般事件'}, { id: '2222', name: 'ceshi'} ] }
};
    return res.status(200).send(results);
  });
  ...
  router.post('/session', function(req, res) {
    const startTime = new Date().getTime();
    while (new Date().getTime() < startTime + 2000);
    const results = { ecode: 0, data: { user: { id: 'nhy67ujm', email:'liulaoyao@aaa.com', first_name: 'liulaoyao', avatar: '', permissions: {sys_admin: true}, latest_access_url: '/project/boba/summary' }}};
    return res.status(200).send(results);
  });
  ...
  router.get('/session', function(req, res) {
    const startTime = new Date().getTime();
    while (new Date().getTime() < startTime + 2000);
    const results = { ecode: 0, data: { user: { id: 'nhy67ujm', email:'liulaoyao@aaa.com', first_name: 'liulaoyao', avatar: 'http://tp1.sinaimg.cn/2214067364/180/5605327547/1', permissions: { sys_admin: true } }}};
    return res.status(200).send(results);
  });
  ...
  router.get('/project/:key/events', function(req, res) {
    const startTime = new Date().getTime();
    while (new Date().getTime() < startTime + 2000);
    const results = { ecode: 0, data: [{ id: '546761', name: '创建问题', notifications: [  'assignee', 'reporter','project_principal', { key: 'role', value: '1111'}, { key: 'single_user_field', value: '1111' } ] },{ id: '546763', name: '编辑问题', notifications: [ 'assignee', 'reporter', 'project_principal', { key: 'multi_user_field', value: '2222' } ] },{ id: '546762', name: '删除问题' },{ id: '2323', name: '添加备注', notifications: [ 'assignee', 'reporter', 'module_principal' ] }], options:{ users: [{ id: '111', name:'刘老幺', email:'liulaoyao@aaa.com' }, { id: '222', name:'李老师', email: 'lilaoshi@aaa.com' }], roles: [{id: '1111', name:'role1'}, {id: '2222', name:'role2'}, {id: '3333', name:'role3'}], single_user_fields: [{id: '1111', name:'field1'}, {id: '2222', name:'field2'}, {id: '3333', name:'field3'}], multi_user_fields: [{id: '1111', name:'field1'}, {id: '2222', name:'field2'}, {id: '3333', name:'field3'}] }};
    return res.status(200).send(results);
  });
  ...
  router.get('/project/:key/activity', function(req, res) {
    const startTime = new Date().getTime();
    while (new Date().getTime() < startTime + 2000);
    const results = { ecode: 0, data: [{ id: '54dd6761', event_key: 'del_file', user : { id : '57afced21d41c8174d7421c1', name : '刘老幺', email : 'liulaoyao@aaa.com' }, data : 'aaa.jpg', issue: { id: '1111', no: '23', title: '1111111111111' }, created_at: 1520943111 }, { id: '546763', event_key: 'add_file', user : { id : '57afced21d41c8174d7421c1', name : '刘老幺', email : 'liulaoyao@aaa.com' }, data : 'bbb.jpg', issue: { id: '1111', no:'45', title: '1111111111111' }, created_at: 1520929420 }, { id: '546761', event_key: 'create_issue', user : { id : '57afced21d41c8174d7421c1', name : '刘老幺', email : 'liulaoyao@aaa.com' }, issue: { id: '1111', no:'324', title: '1111111111111' }, data: '', created_at: 1520922345 }, { id: '54s6763', user : { id : '57afced21d41c8174d7421c1', name : '刘老幺', email : 'liulaoyao@aaa.com' }, event_key: 'edit_issue', data: [{ field : '主题', after_value : 'jjjjjjj', type : 'Text' }, { field : '优先级', after_value : '一般', type : 'Select'} ], issue: { id: '1111', no: '77', title: '1111111111111' }, created_at: 1520922345 }], options: { current_time: 1520943279 } };
    return res.status(200).send(results);
  });
  /******************Activity***************/
  ...
  router.get('/project/:key/document/directory/0', function(req, res) {
    const startTime = new Date().getTime();
    while (new Date().getTime() < startTime + 2000);
    const results={ecode: 0, data:[{ name: '设计文档', id: '5555', d:1 }, {name: 'aaaa.docx', id: '1111', uploader: { id: '1111', name: '刘老幺' }, uploaded_at: 1533636589, size: 123, parent: '0', index: '1111', versions: []}, {name: 'bbbb.docx', id: '2222', uploader: { id: '1111', name: '刘老幺' }, uploaded_at: 1533636588, size: 10240, parent: '0', index: '2222', versions: []}, {name: 'cccc.xlsx', id: '3333', uploader: { id: '1111', name: '刘老幺' }, uploaded_at: 1533636587, size: 2346111, parent: '0', index: '1111', versions: []}, {name: 'eeee.jpg', id: '4444', uploader: { id: '2222', name: '王老师' }, uploaded_at: 1533636586, size: 1233, parent: '1111', index: '1111', versions: []}], options: { path:[{id: '0', name: 'root'}, {id: '111', name: 'aaaa'}, {id: '222', name: 'bbbb'}] }};
    return res.status(200).send(results);
  });
  /******************document*****************/
