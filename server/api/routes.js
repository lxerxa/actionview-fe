...
export default function(router) {
  ...
  router.get('/project/:key/state', function(req, res) {
    const startTime = new Date().getTime();
    while (new Date().getTime() < startTime + 2000);
    const results = { ecode: 0, data: [{ id: '546761', category:'new', name: '开发中', description: 'aaaaaaaaaaa'},{ id: '546763', category: 'inprogess', name: '待测试', description: 'aaaaaaaaaaa', default: true },{ id: '546762', category: 'completed', name: '已发布' },{ id: '2323', name: '已关闭', description: 'ddddddddddd' }]};
    return res.status(200).send(results);
  });
